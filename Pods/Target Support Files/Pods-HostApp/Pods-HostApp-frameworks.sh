...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/DocScanner/GSSDKCore.framework"
  install_framework "${PODS_ROOT}/DocScanner/GSSDKScanFlow.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EVGPUImage2/EVGPUImage2.framework"
  install_framework "${PODS_ROOT}/PassPortScanner/XavierFramework.framework"
